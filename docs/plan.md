...
2026-09-07 미팅 이후 후속은 [`meeting-2026-09-07.md`](meeting-2026-09-07.md). 한도 **공식 연동이 아니라** 정성 보조·활용 이력. 주분석은 유지하고, 위험국 축소·선행 사례·(실패 시) 업종 접기를 더한다. 국가등급이 RI 구성에 들어감이 확인됐으므로 등급 상관을 독립 검증으로 쓰지 않는다.
...
총위험량 기대 방향: RI↑ → 총위험량↑ (총위험량 = 익스포저 규모).

## 후속 (데이터 수신 후)

- 과업 A: 국가등급 5·6·7(+ 심층감시국) 부분집합, 등급 변동 선행 사례. 혼재 월 집계 대안(최빈 등)은 민감도.
- 과업 B: 인수 금액 비중으로 업종 RI 요약. 검증이 아니라 신규 표.
- 과업 C(거시): 이 레포 밖.
